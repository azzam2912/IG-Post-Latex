% Japan JMO Preliminary 2025
\begin{center}
    {\color{crimson}\textbf{\Huge Japan JMO Preliminary 2025}}\\[4pt]
...
\begin{center}
\textit{Ambil $1$ batu dari setiap kotak yang berisi paling sedikit $1$ batu. Lalu, siapkan sebuah kotak kosong baru dan masukkan semua batu yang tadi diambil ke dalam kotak baru tersebut.}
\end{center}
...
\begin{remark*}
    \begin{itemize}
        \item Operasi ini sebenarnya punya nama: \textcrimson{\textbf{Bulgarian Solitaire}}. Tapi ngga tau namanya pun ngga masalah, yang penting paham geraknya.
        ...
        \item Terakhir, banyaknya kotak yang lagi hidup ternyata nyambung sama bilangan segitiga $T_k = \tfrac{k(k+1)}{2}$. Tinggal cari $k$ yang pas.
    \end{itemize}
\end{remark*}

Mari kita jalankan operasinya untuk $N=6$ batu sebagai gambaran (angka menyatakan isi tiap kotak, diurutkan dari yang terbanyak):
\begin{align*}
