% Alg ketaksamaan dari 103 trigonometry
    \title{\textcrimson{\textbf{\Huge Ketaksamaan yang \textit{innocent} tapi caranya hah hoh}}}
    \author{\large Solution by Azzam L. H.}
\maketitle
