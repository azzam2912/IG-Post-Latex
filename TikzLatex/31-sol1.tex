...
\begin{tikzpicture}[scale=2.3,line cap=round,line join=round]
  ...
  \draw[line width=1.00pt,color=wewdxt] (0.31844,-1.92742) circle (0.45851);
  ...
  \draw[line width=1.00pt,color=ffqqtt] (-0.35978,-0.42119) circle (0.84404);
  \draw[line width=1.00pt,color=qqwwzz] (0.116,-1.34377) circle (0.23525);
