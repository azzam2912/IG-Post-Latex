...
\begin{tikzpicture}[scale=2.4,line cap=round,line join=round]
  ...
  \draw[line width=0.80pt,color=dcrutc] (-1.97607,0.50328)--(-0.77378,-0.24788);
  \draw[line width=0.80pt,color=dcrutc] (-0.77378,-0.24788)--(-3.09778,0.78897);
  \draw[line width=0.80pt,color=dcrutc] (-0.77378,-0.24788)--(0.42705,0.5056);
  ...
  \node[font=\small] at (0.00618,-0.01817) {$O$};
  \fill (-2.40199,-1.16905) circle (1.3pt);
  \node[font=\small] at (-2.56448,-1.27527) {$B$};
  \fill (2.40424,-1.16441) circle (1.3pt);
  \node[font=\small] at (2.44621,-1.07527) {$A$};
  \fill (-1.55015,2.1756) circle (1.3pt);
  \node[font=\small] at (-1.61112,2.37252) {$C$};
  \fill (-1.97607,0.50328) circle (1.3pt);
  \node[font=\small] at (-1.99249,0.57518) {$D$};
  \fill (0.42705,0.5056) circle (1.3pt);
  \node[font=\small] at (0.46754,0.58456) {$E$};
  \fill (0.00258,-2.67137) circle (1.3pt);
  \node[font=\small] at (0.00618,-2.69443) {$M$};
  \fill (-0.77378,-0.24788) circle (1.3pt);
  \node[font=\small] at (-0.75278,-0.35503) {$K$};
  \fill (-3.09778,0.78897) circle (1.3pt);
  \node[font=\small] at (-3.25842,0.96588) {$P$};
  \fill (1.17396,1.3899) circle (1.3pt);
  \node[font=\small] at (1.20837,1.56605) {$Q$};
\end{tikzpicture}
\end{center}
